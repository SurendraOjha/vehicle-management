                    ...
                    <div class="tab-content mt-0">
                        <div class="tab-pane  @if(!session()->get('errors')) active show @endif" id="Users">
                            <div class="table-responsive">
                                ...
                                {!! Form::model($information,['route' => ['personal-consultancy.update',$information->id], 'method' => 'post','files'=>true]) !!}
                                ...
                                {{ Form::label('personal_consultancy','Change Term For Module') }}

                                {{ Form::text('personal_consultancy',$setting->personal_consultancy,['class'=>'form-control','required'=>'required']) }}
                                </div>
                                <hr>
