...
<div id="main-content">
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <a class="btn btn-success" href="{{ route('personal-consultancy.create') }}">Create {{ $setting->personal_consultancy }}</a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('personal-consultancy.edit',$value->id)}}"> <i
                                                        class="icon-pencil"></i> </a>
                                                </a>



                                                <form method="post" action="{{ route('personal-consultancy.destroy',$value->id) }}">
                                                    @csrf
                                                    @method('DELETE')
