                    ...
                    <div class="tab-content mt-0">
                        <div class="tab-pane  @if(!session()->get('errors')) active show @endif" id="Users">
                            <div class="table-responsive">
                                ...
                                {!! Form::model($information,['route' => ['course.update',$information->id], 'method' => 'post','files'=>true]) !!}

                                <hr>
                                <div class="form-group">

                                {{ Form::label('courses','Change Term For Module') }}

                                {{ Form::text('courses',$setting->courses,['class'=>'form-control','required'=>'required']) }}
                                </div>
                                <hr>
                                @csrf
                                @method('PUT')
