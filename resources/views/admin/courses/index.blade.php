...
<div id="main-content">
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <a class="btn btn-success" href="{{ route('course.create') }}">Create {{ $setting->courses }}</a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('course.edit',$value->id)}}"> <i
                                                        class="icon-pencil"></i> </a>
                                                </a>



                                                <form method="post" action="{{ route('course.destroy',$value->id) }}">
                                                    @csrf
                                                    @method('DELETE')
