...
<div id="main-content">
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <a class="btn btn-success" href="{{ route('who-are-we.create') }}">Create {{ $setting->who_are_we }}</a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('who-are-we.edit',$value->id)}}"> <i
                                                        class="icon-pencil"></i> </a>
                                                </a>



                                                <form method="post" action="{{ route('who-are-we.destroy',$value->id) }}">
                                                    @csrf
                                                    @method('DELETE')
