...
<div id="main-content">
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <a class="btn btn-success" href="{{ route('stock-analysis.create') }}">Create {{ $setting->stock_analysis }}</a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('stock-analysis.edit',$value->id)}}"> <i
                                                        class="icon-pencil"></i> </a>
                                                </a>



                                                <form method="post" action="{{ route('stock-analysis.destroy',$value->id) }}">
                                                    @csrf
                                                    @method('DELETE')
